...
const Header = () => {
    return (
        <header className="antialiased">
            <nav className="border-gray-200 px-4 lg:px-6 py-2.5  border-b-[2px]">
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <div className="flex items-center lg:order-2">
                            ...
                            <div className="grid grid-cols-3 gap-4 p-4">
                                ...
                                >
                                    <svg
                                        ...
                                        viewBox="0 0 18 18"
                                    >
                                        <path d="M15.977.783A1 1 0 0 0 15 0H3a1 1 0 0 0-.977.783L.2 9h4.239a2.99 2.99 0 0 1 2.742 1.8 1.977 1.977 0 0 0 3.638 0A2.99 2.99 0 0 1 13.561 9H17.8L15.977.783ZM6 2h6a1 1 0 1 1 0 2H6a1 1 0 0 1 0-2Zm7 5a1 1 0 1 1-2 0V7h2v2Z" />
                                        <path d="M1 18h16a1 1 0 0 0 1-1v-6h-4.439a.99.99 0 0 0-.908.6 3.978 3.978 0 0 1-7.306 0 .99.99 0 0 0-.908-.6H0v6a1 1 0 0 0 1 1Z" />
                                    </svg>
                                    <div className="text-sm font-medium text-gray-900 dark:text-white">
                                        Inbox
                        ...
                        <div className="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                            <SignedIn>
                                <UserButton />
                            </SignedIn>
                        </div>
