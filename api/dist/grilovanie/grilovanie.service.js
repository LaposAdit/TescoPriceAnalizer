...
exports.GrilovanieService = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = require("@nestjs/axios");
const rxjs_1 = require("rxjs");
const prisma_service_1 = require("../prisma.service");
const header_1 = require("../common/header");
let GrilovanieService = class GrilovanieService {
    constructor(httpService, prisma) {
        this.httpService = httpService;
        this.prisma = prisma;
        this.cookies = '';
    }
    async refreshCookiesAndCsrfToken() {
        try {
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get('https://potravinydomov.itesco.sk/groceries/sk-SK/shop/grilovanie/all?viewAll=promotion', {
                headers: {
    ...
    async getProducts(update, page, pageSize, sale) {
        ...
        const whereClause = { category: 'grilovanie' };
        if (sale !== undefined) {
...
exports.GrilovanieService = GrilovanieService;
exports.GrilovanieService = GrilovanieService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService,
        prisma_service_1.PrismaService])
], GrilovanieService);
//# sourceMappingURL=grilovanie.service.js.map