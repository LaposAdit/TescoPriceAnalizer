...
exports.SpecialnaAZdravaVyzivaService = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = require("@nestjs/axios");
const rxjs_1 = require("rxjs");
const prisma_service_1 = require("../prisma.service");
const header_1 = require("../common/header");
let SpecialnaAZdravaVyzivaService = class SpecialnaAZdravaVyzivaService {
    ...
    async getProducts(update, page, pageSize, sale) {
        ...
        const whereClause = { category: 'specialna-a-zdrava-vyziva' };
        if (sale !== undefined) {
...
exports.SpecialnaAZdravaVyzivaService = SpecialnaAZdravaVyzivaService;
exports.SpecialnaAZdravaVyzivaService = SpecialnaAZdravaVyzivaService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService,
        prisma_service_1.PrismaService])
], SpecialnaAZdravaVyzivaService);
//# sourceMappingURL=specialna-a-zdrava-vyziva.service.js.map