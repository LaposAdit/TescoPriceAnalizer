...
exports.StarostlivostODomacnostService = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = require("@nestjs/axios");
const rxjs_1 = require("rxjs");
const prisma_service_1 = require("../prisma.service");
const header_1 = require("../common/header");
let StarostlivostODomacnostService = class StarostlivostODomacnostService {
    ...
    async getProducts(update, page, pageSize, sale) {
        ...
        const whereClause = { category: 'starostlivost-o-domacnost' };
        if (sale !== undefined) {
...
exports.StarostlivostODomacnostService = StarostlivostODomacnostService;
exports.StarostlivostODomacnostService = StarostlivostODomacnostService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService,
        prisma_service_1.PrismaService])
], StarostlivostODomacnostService);
//# sourceMappingURL=starostlivost-o-domacnost.service.js.map