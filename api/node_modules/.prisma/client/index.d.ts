...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'favorite' | 'ovocieAZeleniny' | 'grilovanie' | 'pecivo' | 'masoRybyALahodky' | 'mliecneVyrobkyAVajcia' | 'trvanlivePotraviny' | 'specialnaAZdravaVyziva' | 'mrazenePotraviny' | 'napoje' | 'alkohol' | 'promotion'
